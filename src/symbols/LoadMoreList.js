  ...
  renderRow({ item, index }) {
    return (
      <View
        style={
          index % 2 != 0 ? (
            [S.row, { backgroundColor: this.props.section.color + "1A" }]
          ) : (
            S.row
          )
        }
      ...
      <View style={S.container}>
        <ListViewWithScrollController
          ...
          renderFooter={this.renderFooter.bind(
            this
          )} /* (optional) footer component / loadMore options */
          renderGotoTop={this.renderGotoTop.bind(
            this
          )} /* (optional) scrollTo(y:0) controller */
          onLoadMore={this.onLoadMore.bind(
            this
          )} /* (optional) onEndReached & hasMore */
          /* ...any FlatList props */
